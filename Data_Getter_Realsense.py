...
class Data_Getter:
    def __init__(self, freq, output_queue_interpreter, control_queue):
        self.freq = freq
    ...
    def get_Data(self,):
        ...
        while 1:
            if not self.input.empty():
                ...
                if new_data[0] == "REFRESHRATE":
                    self.update_refresh_rate(int(new_data[1]))
                    print("REFRESH Rate Updated" , int(new_data[1]))
